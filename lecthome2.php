	...
	<form>
		...
		<tr>
			<select name="Subject" onchange="location=this.value;">
				<option value="lecthome2.php">----Select subject---</option>
				<option value="lect2subject1.php">Cryptograhy</option>
				<option value="lect2subject2.php">Information Security Standard</option>
				<option value="lect2subject3.php">Critical Infrastructure</option>
