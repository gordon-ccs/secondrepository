<?php
	require('db.php');
	include ("filesLogic4.php");
	include ("filesLogic5.php");
	include ("filesLogic6.php");
	session_start();
	if($_SESSION['student']){
	}
	else
...
<?php
$count=1;
$sel_query="Select * from lect1subject2 ORDER BY id desc;";
...
<center>
	<div class="container">
      <div class="row">
        <form action="stu1subject2.php" method="post" enctype="multipart/form-data" >
...
<td>
<center>
	<button> <a href="downloads4.php">Download version 1</a></button><br>
	<button> <a href="downloads5.php">Download version 2</a></button><br>
	<button> <a href="downloads6.php">Download final version</a></button><br>
</center>
</td>
<?php $count++; } ?>
</tr>
