...
<body>
	...
	<center>
		...
		<?php
			$count=1;
			$sel_query="Select * from lect1subject3 ORDER BY id desc;";
			...
			<tr>
				...
				<td>
			<center>
				<button onclick="myFunction1()">Progress version 1</button>
					<script>
						function myFunction1() {
						location.replace("sub3progress1.php")
							}
						<!--<a href="progress.php" class="btn btn-info">Show Uploaded Files</a>
					</script><br>
					<button onclick="myFunction2()">Progress version 2</button>
					<script>
						function myFunction2() {
						location.replace("sub3progress2.php")
							}
						<!--<a href="progress.php" class="btn btn-info">Show Uploaded Files</a>
					</script><br>
					<button onclick="myFunction3()">Progress Final version</button>
					<script>
						function myFunction3() {
						location.replace("sub3progress3.php")
							}
						<!--<a href="progress.php" class="btn btn-info">Show Uploaded Files</a>
					</script>
			</center>
			...
			<script>
				function myFunction() {
				location.replace("http://localhost/AssignmentSubmissionSystem/lect1submissionplatform3.php")
				}
			</script>
