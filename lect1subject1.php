...
<body>
	...
	<center>
		...
		<tr><td>No</td><td>Homework</td><td>Due date</td><td>Description</td><td>Progress</td></tr>
		...
		<?php
			...
			<center>
				<button onclick="myFunction1()">Progress version 1</button>
					<script>
						...
						location.replace("sub1progress1.php")
							}
					...
					<script>
						...
						location.replace("sub1progress2.php")
							}
						<!--<a href="progress.php" class="btn btn-info">Show Uploaded Files</a>
					</script><br>
					...
					<script>
						...
						location.replace("sub1progress3.php")
							}
						<!--<a href="progress.php" class="btn btn-info">Show Uploaded Files</a>
					</script>
			</center>
			...
			<script>
				function myFunction() {
				location.replace("lect1submissionplatform1.php")
				}
			</script>
