	...
	<form>
		...
		<tr>
			<select name="Subject" onchange="location=this.value;">
				<option value="lecthome3.php">----Select subject---</option>
				<option value="lect3subject1.php">Cryptograhy</option>
				<option value="lect3subject2.php">Information Security Standard</option>
				<option value="lect3subject3.php">Critical Infrastructure</option>
