<?php
	require('db.php');
	include ("filesLogic7.php");
	include ("filesLogic8.php");
...
<center>
	<div class="container">
      <div class="row">
        <form action="stu1subject3.php" method="post" enctype="multipart/form-data" >
...
<center>
	<div class="container">
      <div class="row">
        <form action="stu1subject3.php" method="post" enctype="multipart/form-data" >
          <input type="file" name="myfile9"> <br>
          <button type="submit" name="save" >upload</button>
        </form>
      </div>
    </div>
...
<td>
<center>
	<button> <a href="downloads7.php">Download version 1</a></button><br>
	<button> <a href="downloads8.php">Download version 2</a></button><br>
	<button> <a href="downloads9.php">Download final version</a></button><br>
</center>
</td>
<?php $count++; } ?>
</tr>
